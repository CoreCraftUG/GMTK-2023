...
namespace JamCraft.GMTK2023.Code
{
    public class GameSettingsManager : MonoBehaviour
    {
        ...
        public void SetResolution(int index)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_RESOLUTION, GameSettingsFile.Instance.ResolutionIndex, GameSettingsFile.Instance.UserSettingsFilePath);
            ES3.Save(GameSettingsFile.USERSETTINGS_LASTSAVEDRESOLUTION, GameSettingsFile.Instance.LastSavedResolution, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        private IEnumerator MoveToDisplay(int index)
        {
            ...
            finally
            {
                ...
                ES3.Save(GameSettingsFile.USERSETTINGS_DISPLAY, GameSettingsFile.Instance.DisplayIndex, GameSettingsFile.Instance.UserSettingsFilePath);
                ES3.Save(GameSettingsFile.USERSETTINGS_LASTSAVEDDISPLAY, GameSettingsFile.Instance.LastSavedDisplay, GameSettingsFile.Instance.UserSettingsFilePath);
        ...
        public void SetWindowMode(int index)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_WINDOW_MODE, GameSettingsFile.Instance.WindowModeIndex, GameSettingsFile.Instance.UserSettingsFilePath);
            ES3.Save(GameSettingsFile.USERSETTINGS_LASTSAVEDWINDOWMODE, GameSettingsFile.Instance.LastSavedWindowMode, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        public void SetVSync(bool isChecked)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_VSYNC, GameSettingsFile.Instance.VSync, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        public void SetTextureQuality(int index)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_TEXTURE_QUALITY, GameSettingsFile.Instance.TextureQualityIndex, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        public void SetShadowQuality(int index)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_SHADOW_QUALITY, GameSettingsFile.Instance.ShadowQualityIndex, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        public void SetSoftShadows(bool isChecked)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_SOFT_SHADOWS, GameSettingsFile.Instance.SoftShadows, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        //
        //    ES3.Save(GameSettingsFile.USERSETTINGS_HDR, GameSettingsFile.Instance.HDR, GameSettingsFile.Instance.UserSettingsFilePath);
        //}
        ...
        //
        //    ES3.Save(GameSettingsFile.USERSETTINGS_SSAO, GameSettingsFile.Instance.SSAO, GameSettingsFile.Instance.UserSettingsFilePath);
        //}
        ...
        public void SetCameraDistance(float value)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_CAMERA_DISTANCE, GameSettingsFile.Instance.CameraDistance, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        public void SetMainVolume(float value)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_MAIN_VOLUME, GameSettingsFile.Instance.MainVolume, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        public void SetMusicVolume(float value)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_MUSIC_VOLUME, GameSettingsFile.Instance.MusicVolume, GameSettingsFile.Instance.UserSettingsFilePath);
        }
        ...
        public void SetSFXVolume(float value)
        {
            ...
            ES3.Save(GameSettingsFile.USERSETTINGS_SFX_VOLUME, GameSettingsFile.Instance.SfxVolume, GameSettingsFile.Instance.UserSettingsFilePath);
        }
